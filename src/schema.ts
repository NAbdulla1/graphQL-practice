...
import { type Link, type Comment, Prisma } from '@prisma/client'
...
const resolvers = {
  Query: {
    ...
    feed: async (parent: unknown, args: {filterNeedle?: string}, context: GraphQLContext) => {
  ...
  Link: {
    ...
    createdAt: (parent: Link) => parent.createdAt.toISOString(),
